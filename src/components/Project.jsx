    ...
    <>
      <div className="bg-slate-950 p-2 md:p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 bg-slate-950 p-6 lg:px-12 mx-auto">
          <div className="bg-slate-800 border border-slate-700 rounded-2xl overflow-hidden hover:border-emerald-500/40 hover:shadow-xl hover:shadow-emerald-500/10 transition-all duration-300 h-full flex flex-col">
            ...
            <div className="p-3 md:p-5 flex flex-col flex-1">
              <h2 className="text-xl md:text-2xl font-bold text-white">ShopSphere</h2>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-2xl overflow-hidden hover:border-emerald-500/40 hover:shadow-xl hover:shadow-emerald-500/10 transition-all duration-300 h-full flex flex-col">
            ...
            <div className="p-3 md:p-5 flex flex-col flex-1">
              <h2 className="text-xl md:text-2xl font-bold text-white">Smart Routine Tracker</h2>
              <p className="text-slate-400 text-xs md:text-sm leading-4 mt-2">
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-2xl overflow-hidden hover:border-emerald-500/40 hover:shadow-xl hover:shadow-emerald-500/10 transition-all duration-300 h-full flex flex-col">
            ...
            <div className="p-3 md:p-5 flex flex-col flex-1">
              <h2 className="text-xl md:text-2xl font-bold text-white">GitHub Profile Finder</h2>
              <p className="text-slate-400 text-xs md:text-sm leading-4  mt-2">
                A responsive GitHub profile finder that enables users to search for GitHub
                accounts and explore profile details, repositories, followers, and other
                public information using the GitHub API.
              </p>
              <div className="flex flex-wrap gap-1 md:gap-2 mt-4">
