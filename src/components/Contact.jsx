...
subtext:"linkedin.com/in/shrishti-gupta-584b82373",
  ...
  return (
    ...
    <section id="contact">
      <div className="bg-gray-950 p-4 md:p-10">
        ...
        <div className="flex flex-col md:flex-row justify-between  gap-10 px-2 mt-2  " >
          <div >
  ...
  {contacts.map((item, idx) => (
    ...
    >
      ...
      <div className="leading-tight">
       ...
       <div className="bg-slate-900 rounded-2xl p-4 md:p-8 border border-slate-800 shadow-xl hover:shadow-[0_0_30px_rgba(16,185,129,0.15)] transition-all duration-300">
 <div className="flex items-center gap-2">
  ...
  <p className="text-gray-500 text-sm mt-1 md:text-[16px]">Have a question or want to work together?</p>
  <p className="text-gray-500 text-sm md:text-[16px]">Fill out the form below and I'll get back to you as soon as possible.</p>
  ...
  <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-700 bg-slate-800 py-2 pl-10 pr-3 text-white transition-all placeholder:text-gray-500 focus:border-emerald-500 focus:outline-none"
                    />
                  </div>
